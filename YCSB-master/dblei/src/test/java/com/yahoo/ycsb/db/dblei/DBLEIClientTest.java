...
public class DBLEIClientTest {
  ...
  private DBLEIClient instance;

  public DBLEIClientTest() throws Exception {
    System.out.println("\n\n\t\t\tESTOU A CRIAR A CLASSE\t\t\t\n\n");
    instance = new DBLEIClient();
    instance.init();
  }
  ...
  public void setup() throws Exception {
    ...
    //properties.setProperty(DBLEIClient., tmpFolder.getRoot().getAbsolutePath());
